    ...
    def _load_providers(cls, providers_env: str) -> Dict[str, ProviderConfig]:
        ...
        providers = {
            ...
            "runawaytime": ProviderConfig(
                ...
                status_path="/api/status",
                auth_state_path="/api/oauth/state",
                check_in_path="/api/user/checkin",  # 额外转盘 https://fuli.hxi.me 完成
                check_in_status=False,
                user_info_path="/api/user/self",
                topup_path="/api/user/topup",
            ...
            "manbo": ProviderConfig(
                ...
                github_client_id="Ov23liCuWV2QS06gWce0",
                github_auth_path="/api/oauth/github",
                linuxdo_client_id="dDxQu2MteXZsooGg8J3JygOBuf4hUdua",
                linuxdo_auth_path="/api/oauth/linuxdo",
                aliyun_captcha=False,
                bypass_method=None,
            ),
            ...
            "baqi": ProviderConfig(
                ...
                get_cdk=None,
                api_user_key="new-api-user",
                github_client_id="Ov23likC2BmkjUzdFNS5",
                github_auth_path="/api/oauth/github",
                linuxdo_client_id="ZG8ClfqvP4FqNFWE8EetBZTI8sVzO8R0",
                linuxdo_auth_path="/api/oauth/linuxdo",
                aliyun_captcha=False,
                bypass_method=None,
            ),
            "wow": ProviderConfig(
                name="wow",
                origin="https://linuxdoapi.223384.xyz",
                login_path="/login",
                status_path="/api/status",
                auth_state_path="/api/oauth/state",
                check_in_path="/api/user/checkin",  # 标准 newapi checkin 接口
                ...
                github_client_id="Ov23likC2BmkjUzdFNS5",
                github_auth_path="/api/oauth/github",
                linuxdo_client_id="3fcFoNvesssuyuFsvzBafjWivE4wvTwN",
                linuxdo_auth_path="/api/oauth/linuxdo",
                aliyun_captcha=False,
                bypass_method=None,
            ),
            ...
            "vance": ProviderConfig(
                ...
                get_cdk=None,
                api_user_key="new-api-user",
                github_client_id="Ov23lii109Co4QiNYYpG",
                github_auth_path="/api/oauth/github",
            ...
            "basui": ProviderConfig(
                name="basui",
                origin="https://ai.xoooox.xyz",
                login_path="/login",
                status_path="/api/status",
                auth_state_path="/api/oauth/state",
                check_in_path="/api/user/checkin",  # 标准 newapi checkin 接口
                ...
                github_client_id="Ov23lii109Co4QiNYYpG",
                github_auth_path="/api/oauth/github",
                linuxdo_client_id="wmrvf5VshtsEgzDmxq21iIRCS3Zqb3dy",
                linuxdo_auth_path="/api/oauth/linuxdo",
                aliyun_captcha=False,
                bypass_method=None,
            ),
